#!/usr/bin/env bash
DATASET_PATH="/Users/cheng/LAB/TTC/NVFlare/examples/advanced/xgboost/dataset/HIGGS.csv"
OUTPUT_PATH="/Users/cheng/LAB/TTC/NVFlare/examples/advanced/xgboost/dataset/xgboost_higgs_dataset"
