...
![Centralized validation curve](./figure/Centralized.png)
...
![5 clients validation curve](./figure/5_client.png)
![20 clients validation curve](./figure/20_client.png)
...
inside the `/tmp/nvflare/xgboost_higgs_dataset` directory,
