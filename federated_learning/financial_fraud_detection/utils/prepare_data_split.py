...
def data_split_args_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="uniform",
        choices=["uniform", "linear", "square", "exponential", "IID"],
...
def main():
    ...
    option = args.split_method
    if option == "IID":
        site_size = split_num_proportion(args.size_total, args.site_num, option)
        json_data = {"data_path": args.data_path, "data_index": {}}
    else:
        site_size = split_num_proportion((args.size_total - args.size_valid), args.site_num, option)
